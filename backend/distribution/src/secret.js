...
const serverPort= process.env.SERVER_PORT||3006;
const MongoDBURL= process.env.MONGO_URI || "mongodb+srv://mongodbtkgl:TechKnowGram$5@pustitkgl.u9vkfuq.mongodb.net/doManagement?retryWrites=true&w=majority";
